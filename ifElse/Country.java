class Country {
    public static int getCountryCode(String countryName){
        ...
        else if(countryName=="Caribbean Netherlands"){ 
		countryCode=599; 
		}
        ...
        else if(countryName=="Chatham Island, New Zealand"){ 
		countryCode=64; 
		}
        ...
        else if(countryName=="Congo, Democratic Republic of the"){ 
		countryCode=243; 
		}
        ...
        else if(countryName=="Ivory Coast (Côte d'Ivoire)"){
			countryCode=225;
			}
        ...
        else if(countryName=="Micronesia, Federated States of"){ 
		countryCode=691;
		}
        ...
        else if(countryName=="Northern Cyprus"){ 
		countryCode=90;
		}
        ...
        else if(countryName=="Palestine, State of"){ 
		countryCode=970; 
		}
        ...
        else if(countryName=="Saba"){ 
		countryCode=599; 
		}
        else if(countryName=="Saint Barthélemy"){ 
		countryCode=590; 
		}
        else if(countryName=="Saint Helena"){
			countryCode=290;
			}
        ...
        else if(countryName=="Saint Martin (France)"){
			countryCode=590; 
			}
        ...
        else if(countryName=="Sint Eustatius"){ 
		countryCode=599;
		}
        else if(countryName=="Sint Maarten (Netherlands)"){ 
		countryCode=599; 
		}
        ...
        else if(countryName=="South Georgia and the South Sandwich Islands"){ 
		countryCode=500; 
		}
        else if(countryName=="South Ossetia"){ 
		countryCode=995; 
		}
        ...
        else if(countryName=="Transnistria"){ 
		countryCode=373; 
		}
        else if(countryName=="Trinidad and Tobago"){ 
		countryCode=1868; 
		}
        else if(countryName=="Tristan da Cunha"){
			countryCode=290; 
			}
        ...
        else if(countryName=="US Virgin Islands"){
			countryCode=1340;
			}
        ...
        else if(countryName=="Vatican City State (Holy See)"){
			countryCode=379; 
			}
