class BarRunner{
	static String alcNames[]={"Budwisara","Kingfisher","tuborg","bira","corona","The machalen","Signature","Royal Challengers","Original Choice","Royal Stag","Imperial Blue","OfficersChoice","Ciroc"};
